...
texture = textureconvert.texture()
        ...
        if angle == 90:
            if Direction == 1:
                if f"{KnownX},{FloorKnownY}:{KnownX},{KnownY}" in walls:
                    ...
                    return [KnownX - x, realAmbMult, abs(KnownY - y)]
                else:
                    xOffset += 1
            elif Direction == -1:
                if f"{FloorKnownX},{FloorKnownY}:{FloorKnownX},{KnownY}" in walls:
                    ...
                    return [x - FloorKnownX, realAmbMult, abs(FloorKnownY - y)]
                else:
                    xOffset -= 1
        elif angle == 180:
            if f"{FloorKnownX},{FloorKnownY}:{KnownX},{FloorKnownY}" in walls:
                ...
                return [y - FloorKnownY, realAmbMult, abs(KnownX - x)]
            else:
                yOffset -= 1
        elif Direction == 1:
            ...
            if angle < MaxAngle_RightDown and angle > MaxAngle_UpRight:
                ...
                if f"{KnownX},{math.floor(RayCastHitY)}:{KnownX},{math.ceil(RayCastHitY)}" in walls:
                    ...
                    return [math.sqrt((KnownX - x) ** 2 + (RayCastHitY - y) ** 2), realAmbMult, abs(RayCastHitY - math.ceil(RayCastHitY))]
                else:
                    xOffset += 1
                ...
                if f"{math.floor(RayCastHitX)},{FloorKnownY}:{math.ceil(RayCastHitX)},{FloorKnownY}" in walls:
                    ...
                    return [math.sqrt((y - FloorKnownY) ** 2 + (RayCastHitX - x) ** 2), realAmbMult, abs(math.ceil(RayCastHitX) - RayCastHitX)]
                else:
                    yOffset -= 1
            else:
                ...
                if f"{math.floor(RayCastHitX)},{KnownY}:{math.ceil(RayCastHitX)},{KnownY}" in walls:
                    ...
                    return [math.sqrt((KnownY - y) ** 2 + (RayCastHitX - x) ** 2), realAmbMult, abs(math.floor(RayCastHitX) - RayCastHitX)]
                else:
                    yOffset += 1
            ...
            if angle < MaxAngle_LeftDown and angle > MaxAngle_UpLeft:
                ...
                if f"{FloorKnownX},{math.floor(RayCastHitY)}:{FloorKnownX},{math.ceil(RayCastHitY)}" in walls:
                    ...
                    return [math.sqrt((x - FloorKnownX) ** 2 + (RayCastHitY - y) ** 2), realAmbMult, abs(math.floor(RayCastHitY) - RayCastHitY)]
                else:
                    xOffset -= 1
            ...
            if f"{FloorKnownX},{KnownY}:{KnownX},{KnownY}" in walls:
                ...
                return [KnownY - y, realAmbMult, abs(FloorKnownX - x)]
            else:
                yOffset += 1
    return [-1]
